...
{
    public partial class TicketPopUpVentas :  PopupPage
    {
        public TicketPopUpVentas()
        {
            InitializeComponent();

            MessagingCenter.Subscribe<VentasPageViewModel, HtmlWebViewSource>(this, "ShowTicketVenta", (sender, arg) =>
            {
                browser.Source = arg;
            });
        }
